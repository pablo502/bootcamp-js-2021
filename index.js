...
function onSubmit(event) {
   ...
   tr.innerHTML = `
        ...
        <td>${precio}</td>
        <td>${total}</td>
        <td><a href="#" onclick="onEdit(event)">Editar</a> | <a href="#" onclick="onDelete(event)">Eliminar</a></td></td>
    `;
...
function onEdit(event) {
    ...
    txtCodigo.value = tdCodigo.innerText;
    txtNombre.value = tdNombre.innerText;
    txtCantidad.value = tdCantidad.innerText;
    txtPrecio.value = tdPrecio.innerText;
    selectedCategoria.value = tr.dataset.categoria;
